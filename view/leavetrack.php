                    ...
                    <table class="table datatable-table">
                       <thead class="datatable-header">
                        ...
                        <tr scope="row" data-mdb-index="0">
                                <td class="fixed-cell" data-mdb-field="id"><?php echo $db["id"]; ?></td>
                                <td data-mdb-field="name"><?php echo $db["FirstName"]; ?></td>
                                <td data-mdb-field="leave_type"><?php echo $db["StartDate"]; ?>L</td>
                                <td data-mdb-field="start_date"><?php echo $db["EndDate"]; ?></td>
                                <td data-mdb-field="end_date"><?php echo $db["PhoneNumber"]; ?></td>
                                <td data-mdb-field="contact"><?php echo $db["FirstName"]; ?></td>
