...
<head>
    ...
    <link rel="stylesheet" href="leavtrack.">
                ...
                <div id="datatable" class="datatable">
                    ...
                    <table class="table datatable-table">
                       <thead class="datatable-header">
                        ...
                        <tr scope="row" data-mdb-index="0">
                                <td class="fixed-cell" data-mdb-field="id">1</td>
                                <td data-mdb-field="name">JULS</td>
                                <td data-mdb-field="leave_type">ANNUAL</td>
                                <td data-mdb-field="start_date">10/20/2023</td>
                                <td data-mdb-field="end_date">12/20/2024</td>
                                <td data-mdb-field="contact">091234567890</td>
                                <td data-mdb-field="status">
                                    <select>
                                        <option value="approved">Approved</option>
                                        <option value="pending">Pending</option>
