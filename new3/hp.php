    ...
    <!--DROPDOWN EMPLOYEE-->
        ...
        <div class="dropdown">
          ...
          <div id="leaveManagementDropdown" class="dropdown-content">
            <a class="wee" data-content="leave.php"> Leave Form &nbsp;<i class="fi fi-rs-form"></i></a>
            <a class="wee" data-content="adminleave.php"> Admin Leave &nbsp;<i class="fi fi-rs-form"></i></a>
            <a class="wee" data-content="leavetrack.php">Leave Status &nbsp;<i class="fa-solid fa-chart-gantt"></i></a>
          </div>
        </div>
        <div class="dropdown">
          ...
          <div id="lmsDropdown" class="dropdown-content">
            <a class="wee" data-content="leave.php"> Trainee List  &nbsp;<i class="fi fi-ss-book-open-reader"></i></a>
            <a class="wee" data-content="adminleave.php"> Trainers &nbsp;<i class="fi fi-sr-chalkboard-user"></i></a>
            <a class="wee" data-content="leavetrack.php">Modules &nbsp;<i class="fi fi-ts-book-open-cover"></i></a>
          </div>
        </div>
