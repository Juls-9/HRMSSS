<?php 
    ...
    class addEmployee extends dbh{
        ...
        public function addEmployee(){
            session_start();
            $sql = "INSERT INTO employee_tbl(firstname, lastname, middlename, email, birthday, hire_date, salary, department) VALUES('$this->fname','$this->lname', '$this->mname', '$this->email', '$this->bday', '$this->hdate', '$this->salary','$this->dp')";
